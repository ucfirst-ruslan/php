<?php
define('DB_NOT_CONNECT', 'Connection failed: ');
define('ERROR_FIELD_TABLE', 'Field "TABLE" is not filled');
define('ERROR_WHERE_FIELD', 'Check WHERE options');
define('ERROR_DELETE', 'An error occurred during the DELETE operation. Check options');
